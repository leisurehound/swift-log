...
| [google/SwiftLogFireCloud](https://github.com/google/swiftlogfirecloud)  | a logging backend which sends log messages as flat files to Firebase Cloud Storage buckets in developer configured sizes and time intervals. |
